...
const missionText = [
  "Founded by three Muslim brothers with a shared passion for faith and professional excellence, the Academy is committed to empowering students from all backgrounds to pursue careers in law, finance, technology, and beyond - all while staying firmly grounded in Islamic principles.",
  ...
  "At a time when corporate education is often inaccessible or unfamiliar to many young Muslims, we see a powerful opportunity: to change that narrative, nurture untapped potential, and show that you never have to leave your deen when success calls."
];
      ...
      <section className="mission-main-section animate-on-scroll">
        <div className="container">
          <div className="mission-main-content">
            <p className="mission-main-text">{missionText[0]}</p>
