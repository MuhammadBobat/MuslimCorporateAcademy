        ...
        <div className="socials-container socials-split">
          <div className="socials-left">
            ...
            <div className="social-grid">
              <a href="https://www.tiktok.com/@mca_uk?_t=ZN-8zmFc1nELHa&_r=1" target="_blank" rel="noopener noreferrer" className="social-platform-card animate-on-scroll" data-platform="tiktok">
              ...
              <a href="https://www.instagram.com/mca.uk?igsh=aHExeGQwajdoYWUw" target="_blank" rel="noopener noreferrer" className="social-platform-card animate-on-scroll" data-platform="instagram">
                <div className="platform-icon">
              ...
              <a href="https://linkedin.com/company/muslim-corporate-academy" target="_blank" rel="noopener noreferrer" className="social-platform-card animate-on-scroll" data-platform="linkedin">
                <div className="platform-icon">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
