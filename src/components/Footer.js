        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="social-links">
              <a href="https://www.linkedin.com/in/muslim-corporate-academy-822792383/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
              ...
              <a href="https://www.tiktok.com/@mca_uk?_t=ZN-8zmFc1nELHa&_r=1" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="TikTok">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M9.4 3h3.2c.2 1.8 1.6 3.3 3.4 3.5v3.1c-1.3 0-2.5-.4-3.4-1v5.6c0 2.9-2.3 5.3-5.2 5.3S2 17.1 2 14.2s2.3-5.3 5.2-5.3c.4 0 .8 0 1.2.1v3.2c-.4-.1-.8-.1-1.2-.1-1.2 0-2.1 1-2.1 2.1s.9 2.1 2.1 2.1 2.1-1 2.1-2.1V3z"/>
                </svg>
              </a>
            </div>
          </div>
